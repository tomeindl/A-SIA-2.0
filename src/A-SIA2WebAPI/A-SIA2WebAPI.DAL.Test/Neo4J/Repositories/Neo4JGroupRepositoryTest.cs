...
{
    public class Neo4JGroupRepositoryTest
    {
        private Group _entity;
        private Group _entity2;
        private Neo4JEngine _engine;
        private Neo4JGroupRepository _repository;
        ...
        public void InsertTest()
        {
            ...
            if(inserted == null)
            {
                Assert.Fail("Get returned null, but should be group");
                return;
            }
